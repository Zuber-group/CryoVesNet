...
class ConfusionMatrix:
    ...
    def __str__(self):
        # print("The Pixel Accuracy is: " + str(self.accuracy()))
        # print("The  Intersection-Over-Union is: " + str(self.jaccard_index()))
        # print("The Dice Metric: " + str(self.dice_metric()))
        # print("Former Dice: " + str(self.former_dice()))
