...
class Pipeline():
    ...
    def outcell_remover(self):
        ...
        # os.chdir('./' + image_dir)
        # print(os.getcwd())
        print('imodmop -mode 1 -o 1 -mask 1 seg.mod '+self.image_name+'.nad cytomask.mrc')
        os.system('imodmop -mode 1 -o 1 -mask 1 seg.mod '+self.image_name+'.nad cytomask.mrc')
    ...
    def label_convexer(self):
        ...
        self.corrected_labels = prepyto.pacman_killer(myimage_labels)
